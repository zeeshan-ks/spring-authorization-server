...
public final class TestKeys {
  ...
  public static final String DEFAULT_ENCODED_SECRET_KEY =
      "bCzY/M48bbkwBEWjmNSIEPfwApcvXOnkCxORBEbPr+4=";
  ...
  static {
    X509EncodedKeySpec spec =
        new X509EncodedKeySpec(Base64.getDecoder().decode(DEFAULT_RSA_PUBLIC_KEY));
    try {
  ...
  static {
    PKCS8EncodedKeySpec spec =
        new PKCS8EncodedKeySpec(Base64.getDecoder().decode(DEFAULT_RSA_PRIVATE_KEY));
    try {
  ...
  public static final KeyPair DEFAULT_RSA_KEY_PAIR =
      new KeyPair(DEFAULT_PUBLIC_KEY, DEFAULT_PRIVATE_KEY);

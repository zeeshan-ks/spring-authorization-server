...
public class OAuth2TokenRevocationTests {
  ...
  public void requestWhenRevokeRefreshTokenThenRevoked() throws Exception {
    ...
    this.mvc
        .perform(
            post(DEFAULT_TOKEN_REVOCATION_ENDPOINT_URI)
    ...
    OAuth2Authorization.Token<OAuth2RefreshToken> refreshToken =
        updatedAuthorization.getRefreshToken();
    assertThat(refreshToken.isInvalidated()).isTrue();
    OAuth2Authorization.Token<OAuth2AccessToken> accessToken =
        updatedAuthorization.getAccessToken();
  ...
  public void requestWhenTokenRevocationEndpointCustomizedThenUsed() throws Exception {
    this.spring
        .register(AuthorizationServerConfigurationCustomTokenRevocationEndpoint.class)
        .autowire();
    ...
    when(authenticationProvider.supports(eq(OAuth2TokenRevocationAuthenticationToken.class)))
        .thenReturn(true);
    ...
    verify(authenticationSuccessHandler)
        .onAuthenticationSuccess(any(), any(), eq(tokenRevocationAuthentication));
  }

  private static MultiValueMap<String, String> getTokenRevocationRequestParameters(

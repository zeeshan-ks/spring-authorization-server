...
public class OAuth2AuthorizationServerMetadataTests {
  ...
  @Test
  public void requestWhenAuthorizationServerMetadataRequestAndIssuerSetThenReturnMetadataResponse()
      throws Exception {
    this.spring.register(AuthorizationServerConfiguration.class).autowire();

    this.mvc
        .perform(get(DEFAULT_OAUTH2_AUTHORIZATION_SERVER_METADATA_ENDPOINT_URI))

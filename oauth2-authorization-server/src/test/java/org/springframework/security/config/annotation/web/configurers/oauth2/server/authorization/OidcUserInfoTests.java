...
public class OidcUserInfoTests {
  ...
  public void requestWhenUserInfoRequestGetThenUserInfoResponse() throws Exception {
    ...
    this.mvc
        .perform(
            get(DEFAULT_OIDC_USER_INFO_ENDPOINT_URI)
  ...
  public void requestWhenUserInfoRequestPostThenUserInfoResponse() throws Exception {
    ...
    this.mvc
        .perform(
            post(DEFAULT_OIDC_USER_INFO_ENDPOINT_URI)
                .header(HttpHeaders.AUTHORIZATION, "Bearer " + accessToken.getTokenValue()))
        .andExpect(status().is2xxSuccessful())
        .andExpect(userInfoResponse());
    // @formatter:on
  ...
  @Test
  public void requestWhenSignedJwtAndCustomUserInfoMapperThenMapJwtClaimsToUserInfoResponse()
      throws Exception {
  ...
  // gh-482
  @Test
  public void requestWhenUserInfoRequestThenBearerTokenAuthenticationNotPersisted()
      throws Exception {
    this.spring

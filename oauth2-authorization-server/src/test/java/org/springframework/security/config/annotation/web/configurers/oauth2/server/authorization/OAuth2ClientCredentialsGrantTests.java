...
public class OAuth2ClientCredentialsGrantTests {
  ...
  public void requestWhenTokenRequestNotAuthenticatedThenUnauthorized() throws Exception {
    ...
    this.mvc
        .perform(
            MockMvcRequestBuilders.post(DEFAULT_TOKEN_ENDPOINT_URI)
                .param(
  ...
  public void requestWhenTokenEndpointCustomizedThenUsed() throws Exception {
    ...
    when(authenticationProvider.supports(eq(OAuth2ClientCredentialsAuthenticationToken.class)))
        .thenReturn(true);
    ...
    verify(authenticationSuccessHandler)
        .onAuthenticationSuccess(any(), any(), eq(accessTokenAuthentication));
  }

  @Test
  public void requestWhenClientAuthenticationCustomizedThenUsed() throws Exception {
    this.spring
        .register(AuthorizationServerConfigurationCustomClientAuthentication.class)
        .autowire();
    ...
    when(authenticationProvider.supports(eq(OAuth2ClientAuthenticationToken.class)))
        .thenReturn(true);
  ...
  @EnableWebSecurity
  static class AuthorizationServerConfigurationCustomTokenEndpoint
  ...
  @EnableWebSecurity
  static class AuthorizationServerConfigurationCustomClientAuthentication
      extends AuthorizationServerConfiguration {
    // @formatter:off
    @Bean
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http)

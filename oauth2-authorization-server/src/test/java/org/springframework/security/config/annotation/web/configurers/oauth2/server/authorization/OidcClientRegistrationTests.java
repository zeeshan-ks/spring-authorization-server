...
public class OidcClientRegistrationTests {
  ...
  private static final HttpMessageConverter<OidcClientRegistration>
  ...
  @Autowired private ProviderSettings providerSettings;
  ...
  public static void init() {
    ...
    jwtClientAssertionEncoder =
        new NimbusJwsEncoder((jwkSelector, securityContext) -> jwkSelector.select(clientJwkSet));
    db =
  ...
  @Test
  public void requestWhenClientRegistrationRequestAuthorizedThenClientRegistrationResponse()
      throws Exception {
  ...
  public void requestWhenClientConfigurationRequestAuthorizedThenClientRegistrationResponse()
    ...
    MvcResult mvcResult =
        this.mvc
            .perform(
                get(clientRegistrationResponse.getRegistrationClientUrl().toURI())
                    .headers(httpHeaders))
    ...
    OidcClientRegistration clientConfigurationResponse =
        readClientRegistrationResponse(mvcResult.getResponse());

    assertThat(clientConfigurationResponse.getClientId())
        .isEqualTo(clientRegistrationResponse.getClientId());
    assertThat(clientConfigurationResponse.getClientIdIssuedAt())
        .isEqualTo(clientRegistrationResponse.getClientIdIssuedAt());
    assertThat(clientConfigurationResponse.getClientSecret())
        .isEqualTo(clientRegistrationResponse.getClientSecret());
    ...
    assertThat(clientConfigurationResponse.getClientName())
        .isEqualTo(clientRegistrationResponse.getClientName());
  ...
  private OidcClientRegistration registerClient(OidcClientRegistration clientRegistration)
      throws Exception {
    // ***** (1) Obtain the "initial" access token used for registering the client

    String clientRegistrationScope = "client.create";
    // @formatter:off
    RegisteredClient clientRegistrar =
        RegisteredClient.withId("client-registrar-1")
    ...
    OAuth2AccessToken accessToken =
        readAccessTokenResponse(mvcResult.getResponse()).getAccessToken();
    ...
    mvcResult =
        this.mvc
            .perform(
                post(DEFAULT_OIDC_CLIENT_REGISTRATION_ENDPOINT_URI)
                    .headers(httpHeaders)
    ...
    return JwtClaimsSet.builder()
        ...
        .audience(
            Collections.singletonList(
                asUrl(this.providerSettings.getIssuer(), this.providerSettings.getTokenEndpoint())))
        .issuedAt(issuedAt)
        .expiresAt(expiresAt);
  }
  ...
  private static byte[] getClientRegistrationRequestContent(
  ...
  private static OidcClientRegistration readClientRegistrationResponse(

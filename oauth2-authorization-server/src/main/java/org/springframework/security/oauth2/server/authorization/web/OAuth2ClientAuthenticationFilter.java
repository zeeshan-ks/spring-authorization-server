 ...
 * @see <a target="_blank" href="https://datatracker.ietf.org/doc/html/rfc6749#section-2.3">Section
 *     2.3 Client Authentication</a>
 * @see <a target="_blank"
 *     href="https://datatracker.ietf.org/doc/html/rfc6749#section-3.2.1">Section 3.2.1 Token
...
public final class OAuth2ClientAuthenticationFilter extends OncePerRequestFilter {
   ...
   *
   * @param authenticationManager the {@link AuthenticationManager} used for authenticating the
   *     client
   * @param requestMatcher the {@link RequestMatcher} used for matching against the {@code
   *     HttpServletRequest}
   */
  ...
  /**
   * Sets the {@link AuthenticationConverter} used when attempting to extract client credentials
   * from {@link HttpServletRequest} to an instance of {@link OAuth2ClientAuthenticationToken} used

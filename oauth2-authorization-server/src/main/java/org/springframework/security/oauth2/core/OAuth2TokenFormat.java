...
public final class OAuth2TokenFormat implements Serializable {
  ...
  /**
   * Reference (opaque) tokens are unique identifiers that serve as a reference to the token
   * metadata and claims of the user and/or client, stored at the provider.
   */

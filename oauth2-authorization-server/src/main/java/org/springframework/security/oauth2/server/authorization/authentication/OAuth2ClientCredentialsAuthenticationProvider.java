 ...
 * @see <a target="_blank" href="https://datatracker.ietf.org/doc/html/rfc6749#section-4.4">Section
 *     4.4 Client Credentials Grant</a>
 * @see <a target="_blank"
 *     href="https://datatracker.ietf.org/doc/html/rfc6749#section-4.4.2">Section 4.4.2 Access Token
 *     Request</a>
 */
public final class OAuth2ClientCredentialsAuthenticationProvider implements AuthenticationProvider {
  ...
  // OAuth2ClientCredentialsAuthenticationProvider(OAuth2AuthorizationService, JwtEncoder)
   ...
   *
   * @deprecated Use {@link
   *     #OAuth2ClientCredentialsAuthenticationProvider(OAuth2AuthorizationService,
  ...
  public OAuth2ClientCredentialsAuthenticationProvider(
    ...
    this.tokenGenerator =
        new DelegatingOAuth2TokenGenerator(this.jwtGenerator, new OAuth2AccessTokenGenerator());
  }

...
public class OAuth2TokenIntrospectionHttpMessageConverter
  ...
  private Converter<Map<String, Object>, OAuth2TokenIntrospection> tokenIntrospectionConverter =
      new MapOAuth2TokenIntrospectionConverter();
  private Converter<OAuth2TokenIntrospection, Map<String, Object>>
      tokenIntrospectionParametersConverter = new OAuth2TokenIntrospectionMapConverter();
  ...
  protected OAuth2TokenIntrospection readInternal(
      Class<? extends OAuth2TokenIntrospection> clazz, HttpInputMessage inputMessage)
      throws HttpMessageNotReadableException {
    try {
      Map<String, Object> tokenIntrospectionParameters =
          (Map<String, Object>)
  ...
  protected void writeInternal(
      OAuth2TokenIntrospection tokenIntrospection, HttpOutputMessage outputMessage)
      throws HttpMessageNotWritableException {
    try {
      Map<String, Object> tokenIntrospectionResponseParameters =
          this.tokenIntrospectionParametersConverter.convert(tokenIntrospection);
      this.jsonMessageConverter.write(
          tokenIntrospectionResponseParameters,
  ...
  /**
   * Sets the {@link Converter} used for converting the Token Introspection Response parameters to
   * an {@link OAuth2TokenIntrospection}.
   *
   * @param tokenIntrospectionConverter the {@link Converter} used for converting to an {@link
  ...
  /**
   * Sets the {@link Converter} used for converting an {@link OAuth2TokenIntrospection} to a {@code
  ...
  public final void setTokenIntrospectionParametersConverter(
      Converter<OAuth2TokenIntrospection, Map<String, Object>>
          tokenIntrospectionParametersConverter) {
    Assert.notNull(
        tokenIntrospectionParametersConverter,
        "tokenIntrospectionParametersConverter cannot be null");
  ...
  private static final class MapOAuth2TokenIntrospectionConverter
    ...
    private static final TypeDescriptor BOOLEAN_TYPE_DESCRIPTOR =
  ...
  private static final class OAuth2TokenIntrospectionMapConverter
    ...
    public Map<String, Object> convert(OAuth2TokenIntrospection source) {
      ...
      if (source.getExpiresAt() != null) {
        responseClaims.put(
            OAuth2TokenIntrospectionClaimNames.EXP, source.getExpiresAt().getEpochSecond());
      }
      if (source.getIssuedAt() != null) {
        responseClaims.put(
            OAuth2TokenIntrospectionClaimNames.IAT, source.getIssuedAt().getEpochSecond());
      }
      if (source.getNotBefore() != null) {
        responseClaims.put(
            OAuth2TokenIntrospectionClaimNames.NBF, source.getNotBefore().getEpochSecond());
      }

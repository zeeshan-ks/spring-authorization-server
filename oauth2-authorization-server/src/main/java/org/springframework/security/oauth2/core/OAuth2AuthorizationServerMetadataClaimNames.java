...
/**
 * The names of the "claims" an Authorization Server describes about its configuration, used in
...
public interface OAuth2AuthorizationServerMetadataClaimNames {
  ...
  /**
   * {@code token_endpoint_auth_methods_supported} - the client authentication methods supported by
  ...
  /**
   * {@code revocation_endpoint_auth_methods_supported} - the client authentication methods
   * supported by the OAuth 2.0 Token Revocation Endpoint
   */
  ...
  /**
   * {@code introspection_endpoint_auth_methods_supported} - the client authentication methods
   * supported by the OAuth 2.0 Token Introspection Endpoint
   */
  String INTROSPECTION_ENDPOINT_AUTH_METHODS_SUPPORTED =
      "introspection_endpoint_auth_methods_supported";

  /**
   * {@code code_challenge_methods_supported} - the Proof Key for Code Exchange (PKCE) {@code
   * code_challenge_method} values supported
   */

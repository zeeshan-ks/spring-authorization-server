...
public class OidcProviderConfigurationHttpMessageConverter
  ...
  private Converter<Map<String, Object>, OidcProviderConfiguration> providerConfigurationConverter =
      new OidcProviderConfigurationConverter();
  private Converter<OidcProviderConfiguration, Map<String, Object>>
      providerConfigurationParametersConverter = OidcProviderConfiguration::getClaims;
  ...
  protected OidcProviderConfiguration readInternal(
      Class<? extends OidcProviderConfiguration> clazz, HttpInputMessage inputMessage)
  ...
  protected void writeInternal(
      OidcProviderConfiguration providerConfiguration, HttpOutputMessage outputMessage)
  ...
  /**
   * Sets the {@link Converter} used for converting the OpenID Provider Configuration parameters to
   * an {@link OidcProviderConfiguration}.
   *
   * @param providerConfigurationConverter the {@link Converter} used for converting to an {@link
  ...
  public final void setProviderConfigurationParametersConverter(
      Converter<OidcProviderConfiguration, Map<String, Object>>
  ...
  private static final class OidcProviderConfigurationConverter
    ...
    private OidcProviderConfigurationConverter() {
      ...
      claimConverters.put(
          OidcProviderMetadataClaimNames.TOKEN_ENDPOINT_AUTH_METHODS_SUPPORTED,
      ...
      claimConverters.put(
          OidcProviderMetadataClaimNames.RESPONSE_TYPES_SUPPORTED, collectionStringConverter);
      claimConverters.put(
          OidcProviderMetadataClaimNames.GRANT_TYPES_SUPPORTED, collectionStringConverter);
      claimConverters.put(
          OidcProviderMetadataClaimNames.SUBJECT_TYPES_SUPPORTED, collectionStringConverter);
      claimConverters.put(
          OidcProviderMetadataClaimNames.ID_TOKEN_SIGNING_ALG_VALUES_SUPPORTED,
          collectionStringConverter);
      claimConverters.put(
          OidcProviderMetadataClaimNames.SCOPES_SUPPORTED, collectionStringConverter);

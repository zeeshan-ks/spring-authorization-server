...
/**
 * A representation of an OAuth 2.0 Authorization, which holds state related to the authorization
 * granted to a {@link #getRegisteredClientId() client}, by the {@link #getPrincipalName() resource
 * owner} or itself in the case of the {@code client_credentials} grant type.
 *
 * @author Joe Grandja
...
public class OAuth2Authorization implements Serializable {
  ...
  /**
   * The name of the {@link #getAttribute(String) attribute} used for the authorized scope(s). The
   * value of the attribute is of type {@code Set<String>}.
   */
  ...
  public static class Token<T extends OAuth2Token> implements Serializable {
    ...
    /**
     * Returns {@code true} if the token has been invalidated (e.g. revoked). The default is {@code
     * false}.
     *
  ...
  public static class Builder implements Serializable {
    ...
    /**
     * A {@code Consumer} of the attributes {@code Map} allowing the ability to add, replace, or
     * remove.
     *

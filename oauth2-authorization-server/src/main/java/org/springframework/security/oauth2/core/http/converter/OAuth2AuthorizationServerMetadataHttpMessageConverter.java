...
/**
 * A {@link HttpMessageConverter} for an {@link OAuth2AuthorizationServerMetadata OAuth 2.0
...
public class OAuth2AuthorizationServerMetadataHttpMessageConverter
  ...
  private Converter<Map<String, Object>, OAuth2AuthorizationServerMetadata>
      authorizationServerMetadataConverter = new OAuth2AuthorizationServerMetadataConverter();
  private Converter<OAuth2AuthorizationServerMetadata, Map<String, Object>>
      authorizationServerMetadataParametersConverter = OAuth2AuthorizationServerMetadata::getClaims;
  ...
  protected OAuth2AuthorizationServerMetadata readInternal(
      Class<? extends OAuth2AuthorizationServerMetadata> clazz, HttpInputMessage inputMessage)
    ...
    try {
      ...
      return this.authorizationServerMetadataConverter.convert(
          authorizationServerMetadataParameters);
    } catch (Exception ex) {
      throw new HttpMessageNotReadableException(
          "An error occurred reading the OAuth 2.0 Authorization Server Metadata: "
              + ex.getMessage(),
          ex,
          inputMessage);
    }
  ...
  protected void writeInternal(
    ...
    try {
      ...
      throw new HttpMessageNotWritableException(
          "An error occurred writing the OAuth 2.0 Authorization Server Metadata: "
              + ex.getMessage(),
          ex);
    }
  }
   ...
   *
   * @param authorizationServerMetadataConverter the {@link Converter} used for converting to an
   *     {@link OAuth2AuthorizationServerMetadata}.
   */
  public final void setAuthorizationServerMetadataConverter(
      Converter<Map<String, Object>, OAuth2AuthorizationServerMetadata>
          authorizationServerMetadataConverter) {
    Assert.notNull(
        authorizationServerMetadataConverter,
        "authorizationServerMetadataConverter cannot be null");
    this.authorizationServerMetadataConverter = authorizationServerMetadataConverter;
  }

  /**
   * Sets the {@link Converter} used for converting the {@link OAuth2AuthorizationServerMetadata} to
   * a {@code Map} representation of the OAuth 2.0 Authorization Server Metadata.
   *
   * @param authorizationServerMetadataParametersConverter the {@link Converter} used for converting
   *     to a {@code Map} representation of the OAuth 2.0 Authorization Server Metadata.
   */
  public final void setAuthorizationServerMetadataParametersConverter(
      Converter<OAuth2AuthorizationServerMetadata, Map<String, Object>>
  ...
  private static final class OAuth2AuthorizationServerMetadataConverter
    ...
    private static final ClaimConversionService CLAIM_CONVERSION_SERVICE =
    ...
    private OAuth2AuthorizationServerMetadataConverter() {
      Converter<Object, ?> collectionStringConverter =
          getConverter(TypeDescriptor.collection(Collection.class, STRING_TYPE_DESCRIPTOR));
      ...
      claimConverters.put(
          OAuth2AuthorizationServerMetadataClaimNames.AUTHORIZATION_ENDPOINT, urlConverter);
      ...
      claimConverters.put(
          OAuth2AuthorizationServerMetadataClaimNames.SCOPES_SUPPORTED, collectionStringConverter);
      claimConverters.put(
      ...
      claimConverters.put(
          ...
          collectionStringConverter);
      claimConverters.put(
          OAuth2AuthorizationServerMetadataClaimNames.REVOCATION_ENDPOINT, urlConverter);
      claimConverters.put(
          OAuth2AuthorizationServerMetadataClaimNames.REVOCATION_ENDPOINT_AUTH_METHODS_SUPPORTED,
          collectionStringConverter);
      claimConverters.put(
          OAuth2AuthorizationServerMetadataClaimNames.INTROSPECTION_ENDPOINT, urlConverter);
      claimConverters.put(
    ...
    private static Converter<Object, ?> getConverter(TypeDescriptor targetDescriptor) {
      return (source) ->
          CLAIM_CONVERSION_SERVICE.convert(source, OBJECT_TYPE_DESCRIPTOR, targetDescriptor);
    }
  }
}

...
public final class ProviderSettings extends AbstractSettings {
  ...
  /**
   * Returns the Provider's OAuth 2.0 Authorization endpoint. The default is {@code
   * /oauth2/authorize}.
   *
  ...
  /**
   * Returns the Provider's OAuth 2.0 Token Revocation endpoint. The default is {@code
   * /oauth2/revoke}.
   *
  ...
  /**
   * Returns the Provider's OAuth 2.0 Token Introspection endpoint. The default is {@code
   * /oauth2/introspect}.
   *
  ...
  /**
   * Returns the Provider's OpenID Connect 1.0 Client Registration endpoint. The default is {@code
   * /connect/register}.
   *
  ...
  public static class Builder extends AbstractBuilder<ProviderSettings, Builder> {
    ...
    public Builder authorizationEndpoint(String authorizationEndpoint) {
      return setting(
          ConfigurationSettingNames.Provider.AUTHORIZATION_ENDPOINT, authorizationEndpoint);
    }
    ...
    public Builder tokenRevocationEndpoint(String tokenRevocationEndpoint) {
      return setting(
          ConfigurationSettingNames.Provider.TOKEN_REVOCATION_ENDPOINT, tokenRevocationEndpoint);
    }
    ...
    public Builder tokenIntrospectionEndpoint(String tokenIntrospectionEndpoint) {
      return setting(
          ConfigurationSettingNames.Provider.TOKEN_INTROSPECTION_ENDPOINT,
    ...
    public Builder oidcClientRegistrationEndpoint(String oidcClientRegistrationEndpoint) {
      return setting(
          ConfigurationSettingNames.Provider.OIDC_CLIENT_REGISTRATION_ENDPOINT,
    ...
    public Builder oidcUserInfoEndpoint(String oidcUserInfoEndpoint) {
      return setting(
          ConfigurationSettingNames.Provider.OIDC_USER_INFO_ENDPOINT, oidcUserInfoEndpoint);
    }

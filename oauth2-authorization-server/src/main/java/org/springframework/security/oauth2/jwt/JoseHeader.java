 ...
 * @since 0.0.1
 * @see Jwt
 * @see <a target="_blank" href="https://datatracker.ietf.org/doc/html/rfc7519#section-5">JWT JOSE
 *     Header</a>
 * @see <a target="_blank" href="https://datatracker.ietf.org/doc/html/rfc7515#section-4">JWS JOSE
 *     Header</a>
 * @see <a target="_blank" href="https://datatracker.ietf.org/doc/html/rfc7516#section-4">JWE JOSE
 *     Header</a>
...
public final class JoseHeader {
  ...
  /**
   * Returns the {@link JwaAlgorithm JWA algorithm} used to digitally sign the JWS or encrypt the
   * JWE.
   *
   ...
   * certificate chain corresponding to the key used to digitally sign the JWS or encrypt the JWE.
   * The certificate or certificate chain is represented as a {@code List} of certificate value
   * {@code String}s. Each {@code String} in the {@code List} is a Base64-encoded DER PKIX
   * certificate value.
   *
  ...
  public static final class Builder {
    ...
    /**
     * Sets the {@link JwaAlgorithm JWA algorithm} used to digitally sign the JWS or encrypt the
     * JWE.
     *
     * @param jwaAlgorithm the {@link JwaAlgorithm}
     * @return the {@link Builder}

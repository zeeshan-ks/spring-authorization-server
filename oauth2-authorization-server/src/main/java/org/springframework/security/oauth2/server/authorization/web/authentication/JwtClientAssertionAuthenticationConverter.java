...
/**
 * Attempts to extract a JWT client assertion credential from {@link HttpServletRequest} and then
 * converts to an {@link OAuth2ClientAuthenticationToken} used for authenticating the client.
 *

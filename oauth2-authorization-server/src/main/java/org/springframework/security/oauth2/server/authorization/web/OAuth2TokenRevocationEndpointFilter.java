 ...
 * @see <a target="_blank" href="https://tools.ietf.org/html/rfc7009#section-2">Section 2 Token
 *     Revocation</a>
...
public final class OAuth2TokenRevocationEndpointFilter extends OncePerRequestFilter {
  ...
  private AuthenticationSuccessHandler authenticationSuccessHandler =
      this::sendRevocationSuccessResponse;
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      this.authenticationSuccessHandler.onAuthenticationSuccess(
          request, response, tokenRevocationAuthenticationResult);
   ...
   *     an {@link OAuth2TokenRevocationAuthenticationToken}
   * @since 0.2.2
   */

...
/**
 * An {@link OAuth2TokenContext} implementation that provides access to the {@link #getClaims()
 * claims} of an OAuth 2.0 Token, allowing the ability to customize.
 *
 * @author Joe Grandja
 * @since 0.2.3
...
public final class OAuth2TokenClaimsContext implements OAuth2TokenContext {
  ...
  /**
   * Returns the {@link OAuth2TokenClaimsSet.Builder claims} allowing the ability to add, replace,
   * or remove.
   *
  ...
  public static final class Builder extends AbstractBuilder<OAuth2TokenClaimsContext, Builder> {
    ...
    /**
     * A {@code Consumer} of the {@link OAuth2TokenClaimsSet.Builder claims} allowing the ability to

 ...
 * @see <a target="_blank"
 *     href="https://datatracker.ietf.org/doc/html/rfc6749#section-4.1.3">Section 4.1.3 Access Token
 *     Request</a>
 */
public final class OAuth2AuthorizationCodeAuthenticationProvider implements AuthenticationProvider {
  ...
  // OAuth2AuthorizationCodeAuthenticationProvider(OAuth2AuthorizationService, JwtEncoder)
   ...
   *
   * @deprecated Use {@link
   *     #OAuth2AuthorizationCodeAuthenticationProvider(OAuth2AuthorizationService,

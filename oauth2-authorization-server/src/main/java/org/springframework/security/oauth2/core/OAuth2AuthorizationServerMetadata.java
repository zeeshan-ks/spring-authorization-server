...
/**
 * A representation of an OAuth 2.0 Authorization Server Metadata response, which is returned from
 * an OAuth 2.0 Authorization Server's Metadata Endpoint, and contains a set of claims about the
 * Authorization Server's configuration. The claims are defined by the OAuth 2.0 Authorization
 * Server Metadata specification (RFC 8414).
 *
...
public final class OAuth2AuthorizationServerMetadata
  ...
  public static class Builder extends AbstractBuilder<OAuth2AuthorizationServerMetadata, Builder> {
     ...
     * token_endpoint} and {@code response_types_supported}.
     *

...
/**
 * A representation of an OAuth 2.0 "consent" to an Authorization request, which holds state related
 * to the set of {@link #getAuthorities() authorities} granted to a {@link #getRegisteredClientId()
 * client} by the {@link #getPrincipalName() resource owner}.
 *
 * <p>When authorizing access for a given client, the resource owner may only grant a subset of the
 * authorities the client requested. The typical use-case is the {@code authorization_code} flow, in
 * which the client requests a set of {@code scope}s. The resource owner then selects which scopes
 * they grant to the client.
 *
...
public final class OAuth2AuthorizationConsent implements Serializable {
  ...
  private OAuth2AuthorizationConsent(
      String registeredClientId, String principalName, Set<GrantedAuthority> authorities) {
   ...
   *
   * @param authorizationConsent the {@code OAuth2AuthorizationConsent} used for initializing the
   *     {@link Builder}
  ...
  /**
   * Returns a new {@link Builder}, initialized with the given {@link RegisteredClient#getClientId()
   * registeredClientId} and {@code Principal} name.
   *
  ...
  public static final class Builder implements Serializable {
    ...
    /**
     * Adds a scope to the collection of {@code authorities} in the resulting {@link
     * OAuth2AuthorizationConsent}, wrapping it in a {@link SimpleGrantedAuthority}, prefixed by
     * {@code SCOPE_}. For example, a {@code message.write} scope would be stored as {@code
     * SCOPE_message.write}.
     *
    ...
    /**
     * Adds a {@link GrantedAuthority} to the collection of {@code authorities} in the resulting
    ...
    /**
     * A {@code Consumer} of the {@code authorities}, allowing the ability to add, replace or
     * remove.
     *
    ...
    /**
     * Validate the authorities and build the {@link OAuth2AuthorizationConsent}. There must be at
     * least one {@link GrantedAuthority}.
     *

...
public class OidcUserInfoHttpMessageConverter extends AbstractHttpMessageConverter<OidcUserInfo> {
  ...
  protected OidcUserInfo readInternal(
      Class<? extends OidcUserInfo> clazz, HttpInputMessage inputMessage)
  ...
  /**
   * Sets the {@link Converter} used for converting the UserInfo parameters to an {@link
   * OidcUserInfo}.
   *
   * @param userInfoConverter the {@link Converter} used for converting to an {@link OidcUserInfo}
   */
  public final void setUserInfoConverter(
      Converter<Map<String, Object>, OidcUserInfo> userInfoConverter) {
    Assert.notNull(userInfoConverter, "userInfoConverter cannot be null");
    this.userInfoConverter = userInfoConverter;
  }

  /**
   * Sets the {@link Converter} used for converting the {@link OidcUserInfo} to a {@code Map}
   * representation of the UserInfo.
   *
   * @param userInfoParametersConverter the {@link Converter} used for converting to a {@code Map}
   *     representation of the UserInfo
   */
  ...
  private static final class MapOidcUserInfoConverter
    ...
    private static final TypeDescriptor STRING_OBJECT_MAP_DESCRIPTOR =
        TypeDescriptor.map(Map.class, STRING_TYPE_DESCRIPTOR, OBJECT_TYPE_DESCRIPTOR);

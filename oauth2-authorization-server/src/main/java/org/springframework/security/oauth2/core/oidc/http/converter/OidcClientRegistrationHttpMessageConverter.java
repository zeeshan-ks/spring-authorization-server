...
/**
 * A {@link HttpMessageConverter} for an {@link OidcClientRegistration OpenID Client Registration
...
public class OidcClientRegistrationHttpMessageConverter
  ...
  private Converter<Map<String, Object>, OidcClientRegistration> clientRegistrationConverter =
      new MapOidcClientRegistrationConverter();
  private Converter<OidcClientRegistration, Map<String, Object>>
      clientRegistrationParametersConverter = new OidcClientRegistrationMapConverter();
  ...
  protected OidcClientRegistration readInternal(
      Class<? extends OidcClientRegistration> clazz, HttpInputMessage inputMessage)
  ...
  protected void writeInternal(
      OidcClientRegistration clientRegistration, HttpOutputMessage outputMessage)
      throws HttpMessageNotWritableException {
    try {
      Map<String, Object> clientRegistrationParameters =
          this.clientRegistrationParametersConverter.convert(clientRegistration);
      this.jsonMessageConverter.write(
          clientRegistrationParameters,
  ...
  /**
   * Sets the {@link Converter} used for converting the OpenID Client Registration parameters to an
   * {@link OidcClientRegistration}.
   *
   * @param clientRegistrationConverter the {@link Converter} used for converting to an {@link
  ...
  /**
   * Sets the {@link Converter} used for converting the {@link OidcClientRegistration} to a {@code
   * Map} representation of the OpenID Client Registration parameters.
   *
  ...
  public final void setClientRegistrationParametersConverter(
      Converter<OidcClientRegistration, Map<String, Object>>
          clientRegistrationParametersConverter) {
    Assert.notNull(
        clientRegistrationParametersConverter,
  ...
  private static final class MapOidcClientRegistrationConverter
    ...
    private static final TypeDescriptor INSTANT_TYPE_DESCRIPTOR =
        TypeDescriptor.valueOf(Instant.class);
    private static final TypeDescriptor URL_TYPE_DESCRIPTOR = TypeDescriptor.valueOf(URL.class);
    private static final Converter<Object, ?> INSTANT_CONVERTER =
        getConverter(INSTANT_TYPE_DESCRIPTOR);
    ...
    private MapOidcClientRegistrationConverter() {
      ...
      claimConverters.put(
          OidcClientMetadataClaimNames.TOKEN_ENDPOINT_AUTH_SIGNING_ALG, stringConverter);
      ...
      claimConverters.put(
          OidcClientMetadataClaimNames.SCOPE, MapOidcClientRegistrationConverter::convertScope);
      claimConverters.put(OidcClientMetadataClaimNames.JWKS_URI, urlConverter);
      claimConverters.put(
          OidcClientMetadataClaimNames.ID_TOKEN_SIGNED_RESPONSE_ALG, stringConverter);
    ...
    public OidcClientRegistration convert(Map<String, Object> source) {
      ...
      Object clientSecretExpiresAt =
          parsedClaims.get(OidcClientMetadataClaimNames.CLIENT_SECRET_EXPIRES_AT);
  ...
  private static final class OidcClientRegistrationMapConverter
    ...
    public Map<String, Object> convert(OidcClientRegistration source) {
      ...
      if (source.getClientIdIssuedAt() != null) {
        responseClaims.put(
            OidcClientMetadataClaimNames.CLIENT_ID_ISSUED_AT,
      ...
      if (source.getClientSecret() != null) {
        ...
        responseClaims.put(
            OidcClientMetadataClaimNames.CLIENT_SECRET_EXPIRES_AT, clientSecretExpiresAt);
      }

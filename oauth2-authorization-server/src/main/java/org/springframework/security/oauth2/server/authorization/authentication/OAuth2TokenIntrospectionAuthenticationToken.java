...
public class OAuth2TokenIntrospectionAuthenticationToken extends AbstractAuthenticationToken {
  ...
  /**
   * Constructs an {@code OAuth2TokenIntrospectionAuthenticationToken} using the provided
   * parameters.
   *
   ...
   */
  public OAuth2TokenIntrospectionAuthenticationToken(
      String token,
   ...
   */
  public OAuth2TokenIntrospectionAuthenticationToken(
      String token, Authentication clientPrincipal, OAuth2TokenIntrospection tokenClaims) {
    super(Collections.emptyList());
    Assert.hasText(token, "token cannot be empty");
    Assert.notNull(clientPrincipal, "clientPrincipal cannot be null");

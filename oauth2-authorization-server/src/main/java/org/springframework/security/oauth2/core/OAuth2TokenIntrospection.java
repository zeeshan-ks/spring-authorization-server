 ...
 * @see <a target="_blank" href="https://tools.ietf.org/html/rfc7662#section-2.2">Section 2.2
...
public final class OAuth2TokenIntrospection
  ...
  /**
   * Constructs a new {@link Builder} initialized with the {@link #isActive() active} claim to
   * {@code false}.
   *
  ...
  /**
   * Constructs a new {@link Builder} initialized with the provided {@link #isActive() active}
   * claim.
   *
  ...
  public static class Builder {
    ...
    /**
     * A {@code Consumer} of the scope(s) associated with this token, allowing the ability to add,
     * replace, or remove, OPTIONAL.
     *
    ...
    /**
     * Sets the human-readable identifier for the resource owner who authorized this token,
     * OPTIONAL.
     *
     * @param username the human-readable identifier for the resource owner who authorized this
     *     token
     * @return the {@link Builder} for further configuration
     */
    ...
    /**
     * Sets the subject of the token, usually a machine-readable identifier of the resource owner
     * who authorized this token, OPTIONAL.
     *
    ...
    /**
     * A {@code Consumer} of the intended audience(s) for this token, allowing the ability to add,
     * replace, or remove, OPTIONAL.
     *
     ...
     *
     * <p>The following claims are REQUIRED: {@code active}
     *

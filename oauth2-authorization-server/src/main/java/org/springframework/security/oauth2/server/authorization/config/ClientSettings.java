...
public final class ClientSettings extends AbstractSettings {
   ...
   *
   * @return {@code true} if the client is required to provide a proof key challenge and verifier,
  ...
  /**
   * Returns {@code true} if authorization consent is required when the client requests access. The
   * default is {@code false}.
   *
   * @return {@code true} if authorization consent is required when the client requests access,
   *     {@code false} otherwise
   */
  ...
  public static class Builder extends AbstractBuilder<ClientSettings, Builder> {
     ...
     *
     * @param requireProofKey {@code true} if the client is required to provide a proof key
     *     challenge and verifier, {@code false} otherwise
     ...
     * This applies to all interactive flows (e.g. {@code authorization_code} and {@code
     * device_code}).
     *
     * @param requireAuthorizationConsent {@code true} if authorization consent is required when the
     *     client requests access, {@code false} otherwise
     * @return the {@link Builder} for further configuration
     */

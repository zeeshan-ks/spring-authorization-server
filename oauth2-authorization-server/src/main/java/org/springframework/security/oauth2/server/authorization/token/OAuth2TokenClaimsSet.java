...
public final class OAuth2TokenClaimsSet implements OAuth2TokenClaimAccessor {
  ...
  public static final class Builder {
    ...
    /**
     * Sets the issuer {@code (iss)} claim, which identifies the principal that issued the OAuth 2.0
     * Token.
     *
    ...
    /**
     * Sets the audience {@code (aud)} claim, which identifies the recipient(s) that the OAuth 2.0
     ...
     * OAuth 2.0 Token MUST NOT be accepted for processing.
     *
     * @param expiresAt the time on or after which the OAuth 2.0 Token MUST NOT be accepted for
     *     processing
     * @return the {@link Builder}
     */
    ...
    /**
     * Sets the not before {@code (nbf)} claim, which identifies the time before which the OAuth 2.0
     * Token MUST NOT be accepted for processing.
     *
     * @param notBefore the time before which the OAuth 2.0 Token MUST NOT be accepted for
     *     processing
     * @return the {@link Builder}
     */
    ...
    /**
     * Sets the issued at {@code (iat)} claim, which identifies the time at which the OAuth 2.0
     * Token was issued.
     *
    ...
    /**
     * A {@code Consumer} to be provided access to the claims allowing the ability to add, replace,
     * or remove.
     *

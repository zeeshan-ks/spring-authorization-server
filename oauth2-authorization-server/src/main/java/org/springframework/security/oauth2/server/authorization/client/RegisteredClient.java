...
public class RegisteredClient implements Serializable {
  ...
  /**
   * Returns a new {@link Builder}, initialized with the values from the provided {@link
   * RegisteredClient}.
   *
  ...
  public static class Builder implements Serializable {
    ...
    protected Builder(RegisteredClient registeredClient) {
      ...
      this.clientSettings =
          ClientSettings.withSettings(registeredClient.getClientSettings().getSettings()).build();
      this.tokenSettings =
          TokenSettings.withSettings(registeredClient.getTokenSettings().getSettings()).build();
    }
     ...
     * @return the {@link Builder}
     */
    public Builder authorizationGrantTypes(
    ...
    private RegisteredClient create() {
      ...
      registeredClient.clientAuthenticationMethods =
          Collections.unmodifiableSet(new HashSet<>(this.clientAuthenticationMethods));
      registeredClient.authorizationGrantTypes =
          Collections.unmodifiableSet(new HashSet<>(this.authorizationGrantTypes));

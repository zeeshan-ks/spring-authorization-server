...
public final class ConfigurationSettingNames {
  ...
  public static final class Client {
    ...
    public static final String REQUIRE_PROOF_KEY =
        CLIENT_SETTINGS_NAMESPACE.concat("require-proof-key");
    ...
    public static final String REQUIRE_AUTHORIZATION_CONSENT =
        CLIENT_SETTINGS_NAMESPACE.concat("require-authorization-consent");
    ...
    public static final String TOKEN_ENDPOINT_AUTHENTICATION_SIGNING_ALGORITHM =
        CLIENT_SETTINGS_NAMESPACE.concat("token-endpoint-authentication-signing-algorithm");
  ...
  public static final class Provider {
    ...
    public static final String TOKEN_REVOCATION_ENDPOINT =
        PROVIDER_SETTINGS_NAMESPACE.concat("token-revocation-endpoint");

    /** Set the Provider's OAuth 2.0 Token Introspection endpoint. */
    public static final String TOKEN_INTROSPECTION_ENDPOINT =
        PROVIDER_SETTINGS_NAMESPACE.concat("token-introspection-endpoint");
    ...
    public static final String OIDC_CLIENT_REGISTRATION_ENDPOINT =
        PROVIDER_SETTINGS_NAMESPACE.concat("oidc-client-registration-endpoint");

    /** Set the Provider's OpenID Connect 1.0 UserInfo endpoint. */
    public static final String OIDC_USER_INFO_ENDPOINT =
        PROVIDER_SETTINGS_NAMESPACE.concat("oidc-user-info-endpoint");
  ...
  public static final class Token {
    ...
    /**
     * Set to {@code true} if refresh tokens are reused when returning the access token response, or
     * {@code false} if a new refresh token is issued.
     */
    ...
    /**
     * Set the {@link SignatureAlgorithm JWS} algorithm for signing the {@link OidcIdToken ID
     * Token}.
     */
    public static final String ID_TOKEN_SIGNATURE_ALGORITHM =
        TOKEN_SETTINGS_NAMESPACE.concat("id-token-signature-algorithm");

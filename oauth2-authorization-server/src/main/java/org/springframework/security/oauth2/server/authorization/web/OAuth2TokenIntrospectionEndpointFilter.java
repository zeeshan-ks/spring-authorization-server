 ...
 * @see <a target="_blank" href="https://tools.ietf.org/html/rfc7662#section-2.1">Section 2.1
 *     Introspection Request</a>
 * @since 0.1.1
 */
public final class OAuth2TokenIntrospectionEndpointFilter extends OncePerRequestFilter {
   ...
   */
  public OAuth2TokenIntrospectionEndpointFilter(
  ...
  protected void doFilterInternal(
    ...
    try {
      Authentication tokenIntrospectionAuthentication =

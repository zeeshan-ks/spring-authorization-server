...
/**
 * A {@link ClaimAccessor} for the &quot;claims&quot; that may be contained in the Introspection
 * Response.
 *
 * @author David Kovac
 * @since 5.4
 ...
 * @see <a target="_blank" href= "https://tools.ietf.org/html/rfc7662#section-2.2">Introspection
 *     Response</a>
...
public interface OAuth2TokenIntrospectionClaimAccessor extends ClaimAccessor {
  ...
  /**
   * Returns a human-readable identifier {@code (username)} for the resource owner that authorized
   * the token
   *
  ...
  /**
   * Returns usually a machine-readable identifier {@code (sub)} of the resource owner who

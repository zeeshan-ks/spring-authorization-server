...
/**
 * An {@link AuthenticationConverter} that simply delegates to it's internal {@code List} of {@link
 * AuthenticationConverter}(s).
 *
 * <p>Each {@link AuthenticationConverter} is given a chance to {@link
 * AuthenticationConverter#convert(HttpServletRequest)} with the first {@code non-null} {@link
 * Authentication} being returned.
 *
 * @author Joe Grandja
 * @since 0.0.2

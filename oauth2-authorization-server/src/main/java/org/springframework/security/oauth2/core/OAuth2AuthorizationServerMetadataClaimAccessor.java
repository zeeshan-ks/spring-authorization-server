 ...
 * configuration, used in OAuth 2.0 Authorization Server Metadata and OpenID Connect Discovery 1.0.
 *
 * @author Daniel Garnier-Moiroux
 * @since 0.1.1
 * @see ClaimAccessor
 * @see OAuth2AuthorizationServerMetadataClaimNames
 * @see <a target="_blank" href="https://tools.ietf.org/html/rfc8414#section-2">2. Authorization
 *     Server Metadata</a>
 * @see <a target="_blank"
...
public interface OAuth2AuthorizationServerMetadataClaimAccessor extends ClaimAccessor {
  ...
  /**
   * Returns the {@code URL} the Authorization Server asserts as its Issuer Identifier {@code
   * (issuer)}.
   *
  ...
  /**
   * Returns the {@code URL} of the OAuth 2.0 Authorization Endpoint {@code
  ...
  /**
   * Returns the client authentication methods supported by the OAuth 2.0 Token Endpoint {@code
  ...
  /**
   * Returns the OAuth 2.0 {@code response_type} values supported {@code
  ...
  /**
   * Returns the {@code URL} of the OAuth 2.0 Token Revocation Endpoint {@code
   * (revocation_endpoint)}.
   *
   ...
   * {@code (revocation_endpoint_auth_methods_supported)}.
   *
  ...
  /**
   * Returns the {@code URL} of the OAuth 2.0 Token Introspection Endpoint {@code
  ...
  /**
   * Returns the client authentication methods supported by the OAuth 2.0 Token Introspection
   * Endpoint {@code (introspection_endpoint_auth_methods_supported)}.
   *
   * @return the client authentication methods supported by the OAuth 2.0 Token Introspection
   *     Endpoint
   */
  ...
  /**
   * Returns the Proof Key for Code Exchange (PKCE) {@code code_challenge_method} values supported
   * {@code (code_challenge_methods_supported)}.
   *

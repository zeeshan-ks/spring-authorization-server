...
/**
 * Jackson {@code Module} for {@code spring-authorization-server}, that registers the following
 * mix-in annotations:
 *
 * <ul>
 *   <li>{@link UnmodifiableMapMixin}
 *   <li>{@link HashSetMixin}
 *   <li>{@link OAuth2AuthorizationRequestMixin}
 *   <li>{@link DurationMixin}
 *   <li>{@link JwsAlgorithmMixin}
 *   <li>{@link OAuth2TokenFormatMixin}
 * </ul>
 *
 * If not already enabled, default typing will be automatically enabled as type info is required to
 * properly serialize/deserialize objects. In order to use this module just add it to your {@code
 ...
 * </pre>
 *
 * <b>NOTE:</b> Use {@link SecurityJackson2Modules#getModules(ClassLoader)} to get a list of all
 * security modules.
 *
...
public class OAuth2AuthorizationServerJackson2Module extends SimpleModule {
  ...
  public OAuth2AuthorizationServerJackson2Module() {
    super(
        OAuth2AuthorizationServerJackson2Module.class.getName(),
  ...
  public void setupModule(SetupContext context) {
    ...
    context.setMixInAnnotations(
        Collections.unmodifiableMap(Collections.emptyMap()).getClass(), UnmodifiableMapMixin.class);

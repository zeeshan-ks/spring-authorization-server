 ...
 * @see <a target="_blank" href="https://datatracker.ietf.org/doc/html/rfc6749#section-1.5">Section
 *     1.5 Refresh Token Grant</a>
 * @see <a target="_blank" href="https://datatracker.ietf.org/doc/html/rfc6749#section-6">Section 6
...
public final class OAuth2RefreshTokenAuthenticationProvider implements AuthenticationProvider {
  ...
  // TODO Remove after removing @Deprecated
  // OAuth2RefreshTokenAuthenticationProvider(OAuth2AuthorizationService, JwtEncoder)
   ...
   *
   * @deprecated Use {@link #OAuth2RefreshTokenAuthenticationProvider(OAuth2AuthorizationService,
   *     OAuth2TokenGenerator)} instead
   * @param authorizationService the authorization service
   * @param jwtEncoder the jwt encoder
   */
  @Deprecated
  public OAuth2RefreshTokenAuthenticationProvider(
    ...
    this.tokenGenerator =
        new DelegatingOAuth2TokenGenerator(
            this.jwtGenerator, new OAuth2AccessTokenGenerator(), new OAuth2RefreshTokenGenerator());
  }
   ...
   * JwtEncodingContext.Builder#headers(Consumer) headers} and/or {@link
   * JwtEncodingContext.Builder#claims(Consumer) claims} for the generated {@link Jwt}.
   *

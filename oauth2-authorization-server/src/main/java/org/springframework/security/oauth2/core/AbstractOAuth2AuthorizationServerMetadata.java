...
/**
 * A base representation of OAuth 2.0 Authorization Server metadata, returned by an endpoint defined
 * in OAuth 2.0 Authorization Server Metadata and OpenID Connect Discovery 1.0. The metadata
 * endpoint returns a set of claims an Authorization Server describes about its configuration.
 *
 * @author Daniel Garnier-Moiroux
 * @see OAuth2AuthorizationServerMetadataClaimAccessor
 * @since 0.1.1
 * @see <a target="_blank" href="https://tools.ietf.org/html/rfc8414#section-3.2">3.2. Authorization
 *     Server Metadata Response</a>
 * @see <a target="_blank"
 *     href="https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderConfigurationResponse">4.2.
...
public abstract class AbstractOAuth2AuthorizationServerMetadata
  ...
  protected abstract static class AbstractBuilder<
      T extends AbstractOAuth2AuthorizationServerMetadata, B extends AbstractBuilder<T, B>> {
    ...
    protected final B getThis() {
      return (B)
          this; // avoid unchecked casts in subclasses by using "getThis()" instead of "(B) this"
    }
    ...
    /**
     * Use this {@code authorization_endpoint} in the resulting {@link
     * AbstractOAuth2AuthorizationServerMetadata}, REQUIRED.
     *
    ...
    /**
     * Use this {@code token_endpoint} in the resulting {@link
     * AbstractOAuth2AuthorizationServerMetadata}, REQUIRED.
     *
    ...
    /**
     * Add this client authentication method to the collection of {@code
     * token_endpoint_auth_methods_supported} in the resulting {@link
     * AbstractOAuth2AuthorizationServerMetadata}, OPTIONAL.
     *
     * @param authenticationMethod the client authentication method supported by the OAuth 2.0 Token
     *     Endpoint
     * @return the {@link AbstractBuilder} for further configuration
     */
    ...
    /**
     * A {@code Consumer} of the client authentication method(s) allowing the ability to add,
     * replace, or remove.
     *
     * @param authenticationMethodsConsumer a {@code Consumer} of the client authentication
     *     method(s) supported by the OAuth 2.0 Token Endpoint
     * @return the {@link AbstractBuilder} for further configuration
     */
    ...
    /**
     * Use this {@code jwks_uri} in the resulting {@link AbstractOAuth2AuthorizationServerMetadata},
     * OPTIONAL.
     *
    ...
    /**
     * Add this OAuth 2.0 {@code scope} to the collection of {@code scopes_supported} in the
     * resulting {@link AbstractOAuth2AuthorizationServerMetadata}, RECOMMENDED.
     *
    ...
    /**
     * A {@code Consumer} of the OAuth 2.0 {@code scope} values supported allowing the ability to
    ...
    public B scopes(Consumer<List<String>> scopesConsumer) {
      acceptClaimValues(
          OAuth2AuthorizationServerMetadataClaimNames.SCOPES_SUPPORTED, scopesConsumer);
      return getThis();
    }

    /**
     * Add this OAuth 2.0 {@code response_type} to the collection of {@code
     * response_types_supported} in the resulting {@link AbstractOAuth2AuthorizationServerMetadata},
     * REQUIRED.
     *
    ...
    public B responseType(String responseType) {
      addClaimToClaimList(
          OAuth2AuthorizationServerMetadataClaimNames.RESPONSE_TYPES_SUPPORTED, responseType);
      return getThis();
    }

    /**
     * A {@code Consumer} of the OAuth 2.0 {@code response_type} values supported allowing the
     * ability to add, replace, or remove.
     *
     * @param responseTypesConsumer a {@code Consumer} of the OAuth 2.0 {@code response_type} values
     *     supported
     * @return the {@link AbstractBuilder} for further configuration
     */
    ...
    /**
     * Add this OAuth 2.0 {@code grant_type} to the collection of {@code grant_types_supported} in
     * the resulting {@link AbstractOAuth2AuthorizationServerMetadata}, OPTIONAL.
     *
    ...
    public B grantType(String grantType) {
      addClaimToClaimList(
          OAuth2AuthorizationServerMetadataClaimNames.GRANT_TYPES_SUPPORTED, grantType);
      return getThis();
    }

    /**
     * A {@code Consumer} of the OAuth 2.0 {@code grant_type} values supported allowing the ability
     * to add, replace, or remove.
     *
     * @param grantTypesConsumer a {@code Consumer} of the OAuth 2.0 {@code grant_type} values
     *     supported
     * @return the {@link AbstractBuilder} for further configuration
     */
    public B grantTypes(Consumer<List<String>> grantTypesConsumer) {
      acceptClaimValues(
          OAuth2AuthorizationServerMetadataClaimNames.GRANT_TYPES_SUPPORTED, grantTypesConsumer);
      return getThis();
    }

    /**
     * Use this {@code revocation_endpoint} in the resulting {@link
     * AbstractOAuth2AuthorizationServerMetadata}, OPTIONAL.
     *
    ...
    public B tokenRevocationEndpoint(String tokenRevocationEndpoint) {
      return claim(
          OAuth2AuthorizationServerMetadataClaimNames.REVOCATION_ENDPOINT, tokenRevocationEndpoint);
    }

    /**
     * Add this client authentication method to the collection of {@code
     * revocation_endpoint_auth_methods_supported} in the resulting {@link
     * AbstractOAuth2AuthorizationServerMetadata}, OPTIONAL.
     *
     * @param authenticationMethod the client authentication method supported by the OAuth 2.0 Token
     *     Revocation Endpoint
     ...
     *
     * @param authenticationMethodsConsumer a {@code Consumer} of the client authentication
     *     method(s) supported by the OAuth 2.0 Token Revocation Endpoint
     * @return the {@link AbstractBuilder} for further configuration
     */
    ...
    /**
     * Use this {@code introspection_endpoint} in the resulting {@link
     * AbstractOAuth2AuthorizationServerMetadata}, OPTIONAL.
     *
     * @param tokenIntrospectionEndpoint the {@code URL} of the OAuth 2.0 Token Introspection
     *     Endpoint
     * @return the {@link AbstractBuilder} for further configuration
     */
    public B tokenIntrospectionEndpoint(String tokenIntrospectionEndpoint) {
      return claim(
          OAuth2AuthorizationServerMetadataClaimNames.INTROSPECTION_ENDPOINT,
          tokenIntrospectionEndpoint);
    }

    /**
     * Add this client authentication method to the collection of {@code
     * introspection_endpoint_auth_methods_supported} in the resulting {@link
     * AbstractOAuth2AuthorizationServerMetadata}, OPTIONAL.
     *
     * @param authenticationMethod the client authentication method supported by the OAuth 2.0 Token
     ...
     *
     * @param authenticationMethodsConsumer a {@code Consumer} of the client authentication
     *     method(s) supported by the OAuth 2.0 Token Introspection Endpoint
     * @return the {@link AbstractBuilder} for further configuration
     */
    ...
    /**
     * Add this Proof Key for Code Exchange (PKCE) {@code code_challenge_method} to the collection
     * of {@code code_challenge_methods_supported} in the resulting {@link
     * AbstractOAuth2AuthorizationServerMetadata}, OPTIONAL.
     *
    ...
    /**
     * A {@code Consumer} of the Proof Key for Code Exchange (PKCE) {@code code_challenge_method}
     * values supported allowing the ability to add, replace, or remove.
     *
     * @param codeChallengeMethodsConsumer a {@code Consumer} of the {@code code_challenge_method}
     *     values supported
     * @return the {@link AbstractBuilder} for further configuration
     */
    ...
    /**
     * Provides access to every {@link #claim(String, Object)} declared so far with the possibility
     * to add, replace, or remove.
     *
    ...
    protected void validate() {
      Assert.notNull(
          getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.ISSUER),
          "issuer cannot be null");
      validateURL(
          getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.ISSUER),
          "issuer must be a valid URL");
      Assert.notNull(
          getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.AUTHORIZATION_ENDPOINT),
          "authorizationEndpoint cannot be null");
      validateURL(
          getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.AUTHORIZATION_ENDPOINT),
          "authorizationEndpoint must be a valid URL");
      Assert.notNull(
          getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.TOKEN_ENDPOINT),
      ...
      if (getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.JWKS_URI) != null) {
        validateURL(
            getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.JWKS_URI),
      ...
      if (getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.SCOPES_SUPPORTED) != null) {
        ...
        Assert.notEmpty(
            (List<?>) getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.SCOPES_SUPPORTED),
      ...
      if (getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.GRANT_TYPES_SUPPORTED)
          != null) {
        Assert.isInstanceOf(
            List.class,
      ...
      if (getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.REVOCATION_ENDPOINT)
          != null) {
        validateURL(
            getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.REVOCATION_ENDPOINT),
      ...
      if (getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.INTROSPECTION_ENDPOINT)
          != null) {
        validateURL(
            getClaims().get(OAuth2AuthorizationServerMetadataClaimNames.INTROSPECTION_ENDPOINT),

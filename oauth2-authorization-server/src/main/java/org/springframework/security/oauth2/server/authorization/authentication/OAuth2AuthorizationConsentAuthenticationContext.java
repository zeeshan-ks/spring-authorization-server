...
/**
 * An {@link OAuth2AuthenticationContext} that holds an {@link OAuth2AuthorizationConsent.Builder}
 * and additional information and is used when customizing the building of the {@link
...
public final class OAuth2AuthorizationConsentAuthenticationContext
  ...
  /**
   * Constructs a new {@link Builder} with the provided {@link
  ...
  public static final class Builder
    ...
    public OAuth2AuthorizationConsentAuthenticationContext build() {
      Assert.notNull(
          get(OAuth2AuthorizationConsent.Builder.class),

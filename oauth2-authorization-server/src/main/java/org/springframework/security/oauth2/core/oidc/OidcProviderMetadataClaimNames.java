...
/**
 * The names of the "claims" defined by OpenID Connect Discovery 1.0 that can be returned in the
...
public interface OidcProviderMetadataClaimNames
  ...
  /**
   * {@code id_token_signing_alg_values_supported} - the {@link JwsAlgorithm JWS} signing algorithms

...
/**
 * A {@link ClaimAccessor} for the "claims" that may be contained in an {@link
...
public interface OAuth2TokenClaimAccessor extends ClaimAccessor {
  ...
  /**
   * Returns the Issuer {@code (iss)} claim which identifies the principal that issued the OAuth 2.0
   * Token.
   *
  ...
  /**
   * Returns the Subject {@code (sub)} claim which identifies the principal that is the subject of
   * the OAuth 2.0 Token.
   *
  ...
  /**
   * Returns the Audience {@code (aud)} claim which identifies the recipient(s) that the OAuth 2.0
  ...
  /**
   * Returns the Expiration time {@code (exp)} claim which identifies the expiration time on or
   * after which the OAuth 2.0 Token MUST NOT be accepted for processing.
   *
   * @return the Expiration time on or after which the OAuth 2.0 Token MUST NOT be accepted for
   *     processing
   */
  ...
  /**
   * Returns the Not Before {@code (nbf)} claim which identifies the time before which the OAuth 2.0
   * Token MUST NOT be accepted for processing.
   *
   * @return the Not Before time before which the OAuth 2.0 Token MUST NOT be accepted for
   *     processing
   */
  ...
  /**
   * Returns the Issued at {@code (iat)} claim which identifies the time at which the OAuth 2.0
   * Token was issued.
   *

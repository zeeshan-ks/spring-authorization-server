...
public final class ProviderContext {
  ...
  public ProviderContext(
      ProviderSettings providerSettings, @Nullable Supplier<String> issuerSupplier) {
  ...
  /**
   * Returns the {@code URL} of the Provider's issuer identifier. The issuer identifier is resolved
   * from the constructor parameter {@code Supplier<String>} or if not provided then defaults to
   * {@link ProviderSettings#getIssuer()}.
   *

...
/**
 * A {@link ClaimAccessor} for the "claims" that are contained in the OpenID Client Registration
 ...
 * @see <a target="_blank"
 *     href="https://openid.net/specs/openid-connect-registration-1_0.html#ClientMetadata">2. Client
 *     Metadata</a>
 */
public interface OidcClientMetadataClaimAccessor extends ClaimAccessor {
  ...
  /**
   * Returns the time at which the {@code client_secret} will expire {@code
  ...
  /**
   * Returns the authentication method used by the Client for the Token Endpoint {@code
  ...
  /**
   * Returns the {@link JwsAlgorithm JWS} algorithm that must be used for signing the {@link Jwt
   * JWT} used to authenticate the Client at the Token Endpoint for the {@link
   * ClientAuthenticationMethod#PRIVATE_KEY_JWT private_key_jwt} and {@link
   * ClientAuthenticationMethod#CLIENT_SECRET_JWT client_secret_jwt} authentication methods {@code
   * (token_endpoint_auth_signing_alg)}.
   *
   * @return the {@link JwsAlgorithm JWS} algorithm that must be used for signing the {@link Jwt
   *     JWT} used to authenticate the Client at the Token Endpoint
   * @since 0.2.2
   */
  ...
  /**
   * Returns the OAuth 2.0 {@code grant_type} values that the Client will restrict itself to using
   * {@code (grant_types)}.
   *
  ...
  /**
   * Returns the OAuth 2.0 {@code response_type} values that the Client will restrict itself to
   * using {@code (response_types)}.
   *
   * @return the OAuth 2.0 {@code response_type} values that the Client will restrict itself to
   *     using
   */
  ...
  /**
   * Returns the OAuth 2.0 {@code scope} values that the Client will restrict itself to using {@code
   * (scope)}.
   *
  ...
  /**
   * Returns the {@link SignatureAlgorithm JWS} algorithm required for signing the {@link
   * OidcIdToken ID Token} issued to the Client {@code (id_token_signed_response_alg)}.
   *
   * @return the {@link SignatureAlgorithm JWS} algorithm required for signing the {@link
   *     OidcIdToken ID Token} issued to the Client
   */
  ...
  /**
   * Returns the {@code URL} of the Client Configuration Endpoint where the Registration Access
   * Token can be used.
   *
   * @return the {@code URL} of the Client Configuration Endpoint where the Registration Access
   *     Token can be used
   * @since 0.2.1
   */

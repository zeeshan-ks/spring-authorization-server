...
public final class OAuth2TokenIntrospectionEndpointConfigurer extends AbstractOAuth2Configurer {
   ...
   *
   * @param introspectionRequestConverter the {@link AuthenticationConverter} used when attempting
   ...
   *     of {@link OAuth2TokenIntrospectionAuthenticationToken}
   * @return the {@link OAuth2TokenIntrospectionEndpointConfigurer} for further configuration
   */
   ...
   * OAuth2TokenIntrospectionAuthenticationToken}.
   *
   * @param introspectionResponseHandler the {@link AuthenticationSuccessHandler} used for handling
